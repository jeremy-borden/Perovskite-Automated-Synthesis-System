...
def adjusted_sq_efficiency(row):
    ...
    if 'Composition_Type_EA' in row and row['Composition_Type_EA']:
        base_efficiency *= 0.92  # EA affects crystallization (-8%)
...
best_random_params, random_results = random_search_optimization(n_iterations=1000)
...
def genetic_algorithm(n_generations=100, population_size=50, mutation_rate=0.1, tournament_size=5, max_no_improvement=10):
...
best_genetic_params, best_genetic_efficiency = genetic_algorithm(n_generations=50)
