...
class ProcedureFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.title_label = ctk.CTkLabel(
            self, text="Procedure Overview", justify="center", font=("Arial", 20, "bold"))
        ...
        self.start_button.grid(row=0, column=0, rowspan=2,
                               padx=20, pady=20, sticky="nsew")

        self.progress_label = ctk.CTkLabel(
            self.progress_frame, justify="left", text="Procedure Progress: " + str(int(50)) + "%")
        self.progress_label.grid(
            row=0, column=1, padx=20, pady=20, sticky="sw")
        ...
        self.procedure_frame.grid(
            row=1, column=1, padx=5, pady=5, sticky="nsew")

        self.open_button = ctk.CTkButton(
            self.procedure_frame, text="Open Procedure")
        ...
        self.console = ctk.CTkTextbox(
            master=self.console_frame, width=200, height=200, corner_radius=0, state="disabled")
...
if __name__ == "__main__":
    ...
    procedure_frame.grid(row=0, column=0, sticky="nsew")
