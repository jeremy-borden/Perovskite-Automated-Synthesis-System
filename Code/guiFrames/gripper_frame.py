...
class GripperFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.configure(border_color="#1f6aa5", border_width=2, width = 300, height = 200)
        ...
        self.angle1Label = ctk.CTkLabel(self, text="Servo 1 Angle: " + str(int(0)), width = 150)
        self.angle1Label.grid(row=2, column=0, padx=10, pady=10, sticky="nw")

        # Gripper Finger Servo 1 Value Entry
        self.angle1Entry = ctk.CTkEntry(self, placeholder_text="...", width = 50)
        self.angle1Entry.grid(row=2, column=1, padx=10, pady=10, sticky="nw")
        
        # Gripper Servo 1 Entry Button
        self.angle1Button = ctk.CTkButton(self, text="Set", width = 50, command = self.UpdateAngle1)
        self.angle1Button.grid(row=2, column=2, padx=10, pady=10, sticky="nw")
        
        # Gripper Finger Servo 2 Label
        ...
        # Gripper Finger Servo 2 Value Entry
        self.angle2Entry = ctk.CTkEntry(self, placeholder_text="...", width = 50)
        self.angle2Entry.grid(row=3, column=1, padx=10, pady=10, sticky="nw")
        
        # Gripper Servo 2 Entry Button
        self.angle2Button = ctk.CTkButton(self, text="Set", width = 50, command = self.UpdateAngle2)
        self.angle2Button.grid(row=3, column=2, padx=10, pady=10, sticky="nw")
    ...
    def UpdateAngle1(self):
        ...
        self.angle1Label.grid_propagate(False)
